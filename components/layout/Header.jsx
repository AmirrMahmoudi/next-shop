            ...
            <nav className="navbar navbar-expand-lg custom_nav-container">
              ...
              >
                <ul className="navbar-nav mx-auto">
                  ...
                  >
                    <Link className="nav-link" href="/" alt="home-page">
                      صفحه اصلی
                    </Link>
                  </li>
                  <li
                  ...
                  >
                    <Link className="nav-link" href="/menu" alt="menu">
                      منو
                    </Link>
                  </li>
                  <li
                  ...
                  >
                    <Link className="nav-link" href="/about" alt="about">
                      درباره ما
                    </Link>
                  </li>
                  <li
                  ...
                  >
                    <Link className="nav-link" href="/contact" alt="contact">
                      تماس باما
                    </Link>
                  </li>
                </ul>
